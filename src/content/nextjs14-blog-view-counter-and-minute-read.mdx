...
<Image
  ...
  src={`https://res.cloudinary.com/duud9d8dv/image/upload/v1707780778/portfolio/Screenshot_2024-02-12_at_3.32.17_PM_za8zwk.png`}
  width={2812 / 2}
  height={2140 / 2}
  priority
/>
...
The same method is used for the src/app/posts/[slug]/page.tsx. But since we have the slug for the post it makes it simplier to get the value.
